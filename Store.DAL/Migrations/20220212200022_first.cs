        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_Stores_StoreOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsOrder", x => new { x.ProductsId, x.OrderProductsId });
                    table.ForeignKey(
                        name: "FK_ProductsOrder_Order_OrderProductsId",
                        column: x => x.OrderProductsId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductsOrder_Products_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsOrder_OrderProductsId",
                table: "ProductsOrder",
